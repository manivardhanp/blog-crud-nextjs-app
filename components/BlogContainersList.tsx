  ...
  return (
    <div className="mt-12 space-y-4">
      <div className="flex justify-between items-center border-b pb-2">
        <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Active Database Channel Registries</h3>
        <button 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {blogs.map((blog) => (
          ...
          /* 🌟 YOUR EXACT CODE SNIPPET IMPLEMENTED HERE */
          <div key={blog.blogid} className="p-5 border rounded-xl bg-white shadow-sm flex flex-col justify-between hover:border-gray-300 transition">
            <div>
              ...
              <p className="text-xs text-gray-400 font-mono mt-1">Owner Node: #{blog.publicid}</p>
            </div>

            {/* Dynamic Badge Display representing subscribercount */}
